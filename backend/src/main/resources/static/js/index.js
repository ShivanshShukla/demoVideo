...
function handleNewMeeting() {
    ...
    window.open(`video.html?username=${connectedUser.username}`, "_blank");
}
...
function handleJoinMeeting() {
    ...
    const url = `video.html?roomID=${roomId}&username=${connectedUser.username}`;

    window.open(url, "_blank");
}

const joinMeetingBtn = document.getElementById("newMeetingBtn");
